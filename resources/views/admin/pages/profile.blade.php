                ...
                <div class="card shadow-sm border-0 overflow-hidden">
                    <div class="card-body">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <p class="mb-0 text-secondary">{{ $data['user']['city'] ?? 'Unknown' }}, {{ $data['user']['country'] ?? 'Unknown' }}</p>
                    ...
                    <ul class="list-group list-group-flush">
                        <li
                            ...
                            Birthday
                            <span class="badge bg-primary rounded-pill">{{ format_date($data['user']->birthday, 'd F Y') ?? 'Unknown' }}</span>
                        </li>
                    </ul>
                </div>
            </div>
