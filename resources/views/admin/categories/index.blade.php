                        ...
                        <div class="card border shadow-none w-100">
                            <div class="card-body">
                                <form class="row" method="POST"
                                    ...
                                    <div class="col-12">
                                        <x-form.input name="description" label="Short Description"
                                            placeholder="Enter category description" :value="$data['category']->description ?? old('description')" />
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <tbody>
                                        @forelse($data['collections'] as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ $row->icon }}" alt="Category Icon" width="40" height="40" class="rounded-circle">
                                                </td>
                                                <td>{{ $row->name }}</td>
                                                <td>{{ $row->slug }}</td>
