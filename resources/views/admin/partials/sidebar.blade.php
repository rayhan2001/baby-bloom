    ...
    <div class="iconmenu">
        ...
        <ul class="nav nav-pills flex-column">
            <li class="nav-item" title="Dashboards">
                <a href="{{ route('admin.dashboard') }}" class="nav-link text-center {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}"><i class="bi bi-house-door-fill"></i></a>
            </li>
            ...
            <li class="nav-item {{ request()->routeIs('admin.categories.index') ? 'active' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Components">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="pills-ecommerce">
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('admin.brands.index') }}" class="list-group-item"><i class="bi bi-tag"></i>Brands</a>
